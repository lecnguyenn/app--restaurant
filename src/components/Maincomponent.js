...
const mapDispatchProps = (dispatch)=> ({
  ...
  postFeedback: (firstname,lastname,telephone,email,agree,contactType,message)=>dispatch(postFeedback(firstname,lastname,telephone,email,agree,contactType,message)),
